...
#SBATCH -o /dss/dsshome1/07/go82qok2/git/nour/babylm_2026/models/eval_run2_zho_%j.out
...
bash /dss/dsshome1/07/go82qok2/git/nour/babylm-eval/multilingual/scripts/zeroshot_deberta.sh \
    ...
    --langs "zho" \
    --preseg_model /dss/dsshome1/07/go82qok2/git/nour/babylm_2026/tokenizers/zho_spm_8k.model \
